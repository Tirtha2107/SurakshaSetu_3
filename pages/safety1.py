...
def show():
    ...
    if selected == "Live Alerts":
        ...
        st.write("Real-time safety alerts will appear here.")

    elif selected == "Live Travel":
        st.subheader("📍 Live Travel")
        st.write("Safe route planning & live tracking.")
        ...
        st.write("AI-powered crime trend analysis.")
